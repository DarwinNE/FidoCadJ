...
public class ExportGraphic 
{
    ...
    */
    static Dimension getImageSize(ParseSchem P, 
    							  double unitperpixel, 
    							  boolean countMin)
    {
    	int width;
    ...
    */
    ...
    static Point getImageOrigin(ParseSchem P, double unitperpixel)
    {
    	int originx;
		int originy;
		// Unfortunately, to get the image size, we need to redraw it.	
    ...
    */
    static MapCoordinates calculateZoomToFit(ParseSchem P, int sizex, int sizey, 
    				boolean forceCalc)
    {
