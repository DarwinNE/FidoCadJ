...
public class GeometricDistances {
	...
	static final int MAX_BEZIER_SEGMENTS=10;
	...
	*/
	static double pointToPoint(double xa, double ya,
								 double xb, double yb)
	{
	...
	/** Calculate the euclidean distance between two points.
	    ...
	    @param yb the Y coordinate of the second point
	*/
	static int pointToPoint(int xa, int ya,
						 	int xb, int yb)
	{
	...
	*/
	static double pointToSegment(double xa, double ya,
								 double xb, double yb,
								 double x, double y )
	{
		double dx;
	...
	static int pointToSegment(int xa, int ya,
							  int xb, int yb,
							  int x, int y)
	{
	...
	*/
	static boolean pointInPolygon(int npol, 
	...
	*/
	static boolean pointInEllipse(double ex,double ey,double w,
								  double h,double px,double py) 
	{
  	...
  	/** Tells if a point lies inside an ellipse (integer version)
		...
		@return true if the point lies in the ellipse, false otherwise.
	*/
  	static boolean pointInEllipse(int ex,int ey,int w,
								  int h, int px,int py) 
	{
	...
	*/
	static double pointToEllipse(double ex,double ey,double w,
								  double h,double px,double py) 
	{
    	//Determine and normalize quadrant.
    	double dx = Math.abs(px-(ex+w/2));
  	...
  	/** Give the distance between the given point and the ellipse path
		...
		@return the distance to the contour of the ellipse
	*/
  	static int pointToEllipse(int ex,int ey,int w,
								  int h, int px,int py) 
	{
	...
	/** Tells if a point lies inside a rectangle
		...
		@return true if the point lies in the ellipse, false otherwise.
	*/
	static boolean pointInRectangle(double ex,double ey,double w,
								  double h,double px,double py) 
	{
	...
	/** Tells if a point lies inside a rectangle, integer version
		...
		@return true if the point lies in the ellipse, false otherwise.
	*/
	static boolean pointInRectangle(int ex,int ey,int w,
								  int h, int px,int py) 
	{
/*		globals.actualG.drawRect(globals.actualMap.mapX(ex,ey),
	...
	*/
	static double pointToRectangle(double ex,double ey,double w,
								   double h, double px,double py) 
	{
	...
	/** Give the distance between the given point and the borders of a 
		...
		@return the distance to one of the border of the rectangle
	*/
	static int pointToRectangle(int ex,int ey,int w,
								  int h, int px,int py) 
	{
	...
	*/
	...
	static int pointToBezier(int x1, int y1,
								 int x2, int y2,
								 int x3, int y3,
								 int x4, int y4,
								 int px,  int py)
