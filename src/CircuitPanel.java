...
{ //KeyEventDispatcher,
    ...
    static final int SEL_TOLERANCE = 10; // Tolerance in pixel to select an 
                                        // object
    boolean isFilled;
    boolean antiAlias;  // Anti alias flag
    boolean profileTime;
    ...
    static final int MARGIN=20;     // Margin size in pixel when calculating
                                    // component size.
    ...
    static final int NPOLY=100;     // Maximum number of polygon vertices
    private int[] xpoly;
    private int[] ypoly;
    ...
    */
    ...
    private void setPropertiesForPrimitive()
    {
        ...
        if (gp!=null) {
            ...
            DialogParameters dp = new DialogParameters(null,v);
            dp.setVisible(true);
            if(dp.active) {
