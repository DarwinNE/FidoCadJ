...
public class Globals 
{
    ...
    static ResourceBundle messages;             // message bundle
    static int shortcutKey;		// shortcut key to be used:
    							// META (Command) for Mac
    							// CTRL elsewhere
    							
    static boolean useMetaForMultipleSelection;
   	static boolean useNativeFileDialogs; 	// Native file dialogs are 
   								// far better on MacOSX than Linux
   								
   	static boolean weAreOnAMac; // We are on a Mac!!!
   	static boolean quaquaActive; // Quaqua is a better Mac L&F
    ...
    static final boolean doNotUseXOR = true;  // Avoid XOR paint mode
    static final String version = "0.22";     	// version
    static final String DEFAULT_EXTENSION = "fcd";	// Extension
    ...
    */
    static String prettifyPath(String s, int l)
    {
    	if(s.length()<l)
    		return s;
    ...
    */
    static String checkExtension(String p, String ext)
    {
    	int i;
    	String s="";
    ...
    */
    static String getFileNameOnly(String s)
    {
    	int i;
    ...
    */
    static String createCompleteFileName(String path, String filename)
    {
    ...
    */
    ...
    static String substituteBizarreChars(String p, Map bc)
    {
