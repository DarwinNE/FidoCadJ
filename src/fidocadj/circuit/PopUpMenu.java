...
public class PopUpMenu implements ActionListener
{
    ...
    */
    private void definePopupMenu()
    {
        ...
        editProperties.setIcon(Globals.loadIcon("/icons/menu_icons/param.png"));
        ...
        editSymbolize.setIcon(
                Globals.loadIcon("/icons/menu_icons/symbolize.png"));

        editUSymbolize =
            new JMenuItem(Globals.messages.getString("Unsymbolize"));
        editUSymbolize.setIcon(
                Globals.loadIcon("/icons/menu_icons/split_macro.png"));

        editAddNode = new JMenuItem(Globals.messages.getString("Add_node"));
        editAddNode.setIcon(Globals.loadIcon("/icons/menu_icons/add_node.png"));

        editRemoveNode =
            new JMenuItem(Globals.messages.getString("Remove_node"));
        editRemoveNode.setIcon(
                Globals.loadIcon("/icons/menu_icons/remove_node.png"));
