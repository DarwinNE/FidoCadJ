 ...
 * LayerEditor.java
 * 
 * This class defines a custom editor for the layers in a JComboBox within FidoCadJ.
 * It allows for editing the properties of a layer, such as color and visibility, directly from the UI.
 *
 * <pre>
