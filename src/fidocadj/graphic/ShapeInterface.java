...
public interface ShapeInterface
{
    ...
    */
    void createCubicCurve(int x0, int y0, int x1, int y1,
        int x2, int y2, int x3, int y3);

    /** Create a general path with the given number of points.
        @param npoints the number of points.
    */
    void createGeneralPath(int npoints);
    ...
    */
    void curveTo(float x0, float y0, float x1, float y1,
        float x2, float y2);
