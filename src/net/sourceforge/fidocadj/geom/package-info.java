/** <p>
    ...
    Probably, the most important class here is MapCoordinates, which
    contains information about the coordinate mapping, which is changed
    during zoom operations and so on.
    </p>
*/
