...
\begin{itemize}
\item{Courier\index{Courier}: Font con grazie a spaziatura fissa. Vengono convertiti automaticamente in Courier anche le scritte effettuate in Courier New.}
