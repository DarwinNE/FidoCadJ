...
\title{\Huge\color{webbrown} FidoCadJ 0.22 \\ il manuale dell'utente} 
...
\item[Non opere derivate]{Non si può alterare o trasformare quest'opera, nè
...
\textsc{svg}\index{SVG}
&
Formato vettoriale standard del W3C. Alcuni browser Internet (come le versioni recenti di Safari\index{Safari}) permettono di visualizzarlo in una pagina web. Ottimo formato per grafici e schemi, permette di usare programmi come Inkscape\index{Inkscape} per ritoccare i disegni forniti da FidoCadJ. Attualmente, ci sono alcune limitazioni per quanto riguarda l'esportazione del testo ruotato o specchiato.
\\
