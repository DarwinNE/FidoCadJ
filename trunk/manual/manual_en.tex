...
In April 2010, FidoCadJ has been integrated in the well known Italian web site \href{http://www.electroyou.it}{www.electroyou.it}. It silently runs on the server and it is used to automagically convert drawings posted by users of the forum.
...
Copyright \copyright\ 2007-2014 Davide Bucci \href{mailto:davbucci@tiscali.it}{davbucci@tiscali.it}
...
as printed circuit boards\index{PCB}. It was widespread in particular in the italian Usenet community from late 1990s.
...
The output files generated by this software was a very compact textual
description. This feature made it very easy to include drawings in
...
Who uses Linux could run it using WInE\index{WInE}, but for those using
...
file format. Nowadays, I am fortunately not alone and FidoCadJ become a full-fledged Open Source project, with contributions coming from all over the world.
...
the most widespread operating systems.
...
By typing up and down arrow keys, you can navigate through the results found.
...
FidoCadJ allows to draw arrow heads\index{arrows} at the beginning and at the end of lines, Bézier curves and natural cubic splines. It also allows you to specify whether the arrow should be at the beginning or at the end of an element (or both), and offers you a few different arrow styles.
