...
From version 0.23, thanks to Roby IZ1CYN, I could include the IHRaM 3.0 library\index{IHRaM library} directly inside the FidoCadJ distribution. I have done this because among all the libraries I have seen, this one has appeared to be one of the most complete and rationally constructed.
...
\mbox{ }
\vfill
This manual has been written using \textsc{pdf}\LaTeX\ on MacOSX, with the \href{http://www.ctan.org/tex-archive/macros/latex/contrib/classicthesis/}{classicthesis} class.
