...
/** The class dialogExport implements a modal dialog frame which allows the 
	user to select the file name, the format and various options when 
	performing an image export towards a graphic format. 
