...
screenshot of the program running on an old version of MacOSX\index{MacOSX} is shown in Fig.~\ref{fig_fidocadj};\marginpar{Expert Mac-users will notice
...
Appendix~\ref{specifics} describes the peculiarities of the version for Macintosh computers\index{Macintosh}. Recent FidoCadJ versions feature a quick search in the library, as shown in figure~\ref{fig_ricerca}.}
\label{fig_fidocadj}
\end{figure}
