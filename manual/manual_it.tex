...
Del tempo libero che dedico a FidoCadJ, solo una metà circa è dedicata al lavoro del codice. Il resto è costituito dalle risposte alle domande degli utenti e dal lavoro sulla documentazione.
...
Premere \keyevidence{Control} (\keyevidence{Command} con MacOSX) per fare selezioni multiple o deselezionare un solo elemento. 
Fare click e trascinare per selezionare più elementi in un'area. 
Premere \keyevidence{R} per ruotare la selezione. 
Premere \keyevidence{S} per specchiare la selezione. 
...
&
Introduce una linea o una serie di linee. Premere \keyevidence{Esc}, fare click destro  o doppio click sinistro per terminare l'introduzione.
\\
...
This is FidoCadJ, version 0.23.4.
