...
define ("MAIN_SUBTITLE","a free graphical editor for (more than) electronics");

//top navigation menu
define ("HOME_BUTTON","Home");
define ("DOWNLOAD_BUTTON","Download");
define ("SCREENSHOTS_BUTTON","Screenshots");
define ("LIBRARIES_BUTTON","Libraries");
define ("FAQ_BUTTON","FAQ");
define ("EXAMPLES_BUTTON","Examples");
