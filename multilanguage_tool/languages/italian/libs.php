...
//HEAD
define("META_DESCRIPTION","Anche le librerie e i simboli in FidoCadJ sono gratuite. Con questi contribuiti degli utenti è possibile espandere il software."); //page meta tag description

define("PAGE_TITLE","Librerie e Simboli di FidoCadJ"); //page title attribute

//CONTENT
define("FIRST_LINE","Librerie e Simboli"); //FIRST LINE OF TEXT ON THE CONTENT SECTION OF PAGE

define("PARAGRAPH_1",'È possibile <b>scaricare gratuitamente</b> le librerie e i simboli proposti dagli utenti su questa pagina. Per installarle in FidoCadJ, bisogna per prima cosa decomprimerle in una directory a scelta sul proprio computer. Ci saranno uno o più file con l\'estensione fcl (FidoCadJ library).<br/><br/> <strong>Su Windows:</strong> da FidoCadJ, selezionare il menu File, poi Opzioni e nel pannello Avvio selezionare la Directory librerie che contiene i file con estensione fcl.<br/><br/><strong>Su macOS: </strong>dal menu FidoCadJ, raggiungere la voce Impostazioni e nella scheda Avvio, selezionare la cartella contenente i file con estensione fcl.'); //PARAGRAPH TEXT
...
define("LIBRARY_6",'Presentata da Alberto Pellegrini, una raccolta di simboli per le istallazioni <b>idrauliche</b>.'); //LIBRARY DESCRIPTION IN TABLE
...
define("LIBRARY_13",'Libreria offerta da Lorenzo Neri. Contiene alcuni layout SSOP che vanno a correggere qualche <b>errore</b> dei layout presenti nella libreria standard.'); //LIBRARY DESCRIPTION IN TABLE

define("LIBRARY_14",'Realizzata da Nobody, del gruppo Usenet it.discussioni.ingegneria.civile. Contiene alcune azioni e test per <b>l\'analisi strutturale</b>.'); //LIBRARY DESCRIPTION IN TABLE

define("LIBRARY_15",'Realizzata da Mario i3HEV, contiene diversi layout di <b>dispositivi RF</b>: transistor, induttori, trasformatori...'); //LIBRARY DESCRIPTION IN TABLE

define("LIBRARY_16",'A opera di Maurizio Mileto, contiene una corposa raccolta di simboli per gli impianti <b>civili e industriali</b>. FidoCadJ include la versione 2.0 di questa libreria.'); //LIBRARY DESCRIPTION IN TABLE
