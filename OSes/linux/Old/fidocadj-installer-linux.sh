...
make_shell() {
wget -q -O /tmp/mainshellscript.tar.gz http://download.sourceforge.net/fidocadj/files/mainshellscript.tar.gz
tar xvzfm /tmp/mainshellscript.tar.gz -C /usr/bin
...
make_docs() {
wget -q -O /tmp/maindocs.tar.gz http://download.sourceforge.net/fidocadj/files/maindocs.tar.gz
mkdir -p /usr/share/doc/fidocadj
tar xvzfm /tmp/maindocs.tar.gz -C /usr/share/doc/fidocadj
